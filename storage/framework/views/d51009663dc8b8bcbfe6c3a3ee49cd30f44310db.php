      ...
      <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <?php echo Form::open(['url'=>adminUrl('saidabouts/'.$data->id),'method'=>'put','files'=>true]); ?>


                <div class="form-group col-lg-12">
                  <label> الأسم  بالعربى </label>
                  <input type="text" name="name_ar" class="form-control" placeholder="الأسم  بالعربى" required value="<?php echo e(oldOrValue('name_ar',$data)); ?>">
                </div>
                <div class="form-group col-lg-12">
                  <label> الأسم   انجليزى </label>
                  <input type="text" name="name_en" class="form-control" placeholder="الأسم   انجليزى" required value="<?php echo e(oldOrValue('name_en',$data)); ?>">
                </div>
