      ...
      <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
            <?php echo Form::open(['url'=>adminUrl('subjects'),'files'=>true]); ?>


            <div class="form-group col-lg-12">
              <label> عنوان  الموضوع بالعربى </label>
              <input type="text" name="title_ar" class="form-control" placeholder="عنوان  الموضوع بالعربى" required value="<?php echo e(old('title_ar')); ?>">
            </div>
            <div class="form-group col-lg-12">
              <label> عنوان  الموضوع  انجليزى </label>
              <input type="text" name="title_en" class="form-control" placeholder="عنوان  الموضوع  انجليزى" required value="<?php echo e(old('title_en')); ?>">
            </div>
