      ...
      <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <?php echo Form::open(['url'=>adminUrl('subjects/'.$data->id),'method'=>'put','files'=>true]); ?>


                <div class="form-group col-lg-12">
                  <label> عنوان  موضوع الرسالة بالعربى </label>
                  <input type="text" name="title_ar" class="form-control" placeholder="عنوان  موضوع الرسالة بالعربى" required value="<?php echo e(oldOrValue('title_ar',$data)); ?>">
                </div>
                <div class="form-group col-lg-12">
                  <label> عنوان  موضوع الرسالة  انجليزى </label>
                  <input type="text" name="title_en" class="form-control" placeholder="عنوان  موضوع الرسالة  انجليزى" required value="<?php echo e(oldOrValue('title_en',$data)); ?>">
                </div>
