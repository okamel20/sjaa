...
<?php $__env->startSection('script'); ?>
  ...
  <script type="text/javascript">
    ...
    $('.add').on('click',function(){ 
      window.location.href="<?php echo e(\URL::current().'/create?page_id='.request('page_id')); ?>";
    });
    ...
    $('.sendActive').on('click',function(){ 
      $('.form').prop('action','<?php echo e(adminUrl('pagecontents/active/all')); ?>');
      setTimeout(function(){
            $('#form_active').submit();
      }, 500);
    });
    ...
    {
      $('.form').prop('action','<?php echo e(adminUrl('pagecontents/destroy/all')); ?>');
      setTimeout(function(){
            $('#form_active').submit();
      }, 500);
