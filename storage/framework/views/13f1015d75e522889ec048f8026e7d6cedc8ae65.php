    ...
    <div id="multiDelete" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header" <?php if(lang() == 'ar'): ?> dir="ltr" <?php else: ?> dir="rtl" <?php endif; ?>>
...
<?php $__env->startSection('script'); ?>
  ...
  <script type="text/javascript">
    ...
    $('.sendActive').on('click',function(){ 
      $('.form').prop('action','<?php echo e(adminUrl('authors/active/all')); ?>');
      setTimeout(function(){
            $('#form_active').submit();
      }, 500);
    });
    ...
    {
      $('.form').prop('action','<?php echo e(adminUrl('authors/destroy/all')); ?>');
      setTimeout(function(){
            $('#form_active').submit();
      }, 500);
