      ...
      <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              {!! Form::open(['url'=>adminUrl('sliders/'.$data->id),'method'=>'put','files'=>true]) !!}

                <div class="form-group col-lg-12">
                  <label> عالنوان  بالعربى </label>
                  <input type="text" name="title_ar" class="form-control" placeholder="عالنوان  بالعربى" required value="{{ oldOrValue('title_ar',$data) }}">
                </div>
                <div class="form-group col-lg-12">
                  <label> عالنوان   انجليزى </label>
                  <input type="text" name="title_en" class="form-control" placeholder="عالنوان   انجليزى" required value="{{ oldOrValue('title_en',$data) }}">
                </div>
