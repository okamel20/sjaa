...
class ArchivesController extends Controller
{
    ...
    public function __construct() {
        ...
        $this->folder = 'archives';
        $this->indexTitle = 'الطبعات المؤرشفة';
    ...
    public function index(ArchivesDataTable $data)
    {
        
        return indexControllers($this->folder,'الطبعات المؤرشفة',$data);
    }
