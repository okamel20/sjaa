...
class ArchivesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox'  , 'admin.archives.btn.checkbox')
            ->addColumn('edit'      , 'admin.archives.btn.edit')
            ->addColumn('delete'    , 'admin.archives.btn.delete')
            ->addColumn('file'      , 'admin.archives.btn.file')
            ->addColumn('active'    , 'admin.archives.btn.active')
            ->rawColumns([
                'edit',
                'delete' ,
                'checkbox' ,
    ...
    {
        return Edition::orderBy('id','desc')->where('active',0)->get();
    }
