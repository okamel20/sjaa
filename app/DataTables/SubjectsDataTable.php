...
class SubjectsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox'  , 'admin.subjects.btn.checkbox')
            ->addColumn('edit'      , 'admin.subjects.btn.edit')
            ->addColumn('delete'    , 'admin.subjects.btn.delete')
            ->addColumn('active'    , 'admin.subjects.btn.active')
            ->rawColumns([
                'edit',
                'delete' ,
                'checkbox' ,
    ...
    {
        return Contacts_subject::orderBy('id','desc')->get();
    }
