...
class GroupsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox'  , 'admin.groups.btn.checkbox')
            ->addColumn('edit'      , 'admin.groups.btn.edit')
            ->addColumn('delete'    , 'admin.groups.btn.delete')
            ->addColumn('adminCount', 'admin.groups.btn.adminCount')
            ->addColumn('active'    , 'admin.groups.btn.active')
            ->rawColumns([
                'edit',
                'delete' ,
                'checkbox' ,
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name'  => 'group_name_'.lang(),
                'data'  => 'group_name_'.lang(),
                'title' => trans('admin.group')
            ],
            [
                'name'  => 'adminCount',
                'data'  => 'adminCount',
                'title' => trans('admin.adminCount')
            ],
            [
                'name'  => 'active',
                'data'  => 'active',
